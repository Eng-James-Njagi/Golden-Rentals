    ...
    <section className={styles.section}>
      ...
      <div className={styles.header}>
        <div className={styles.headlineWrap}>
          ...
          <h2 className={styles.headline}>Most Viewed Listings</h2>
        </div>
        <p className={styles.subtitle}>
          The properties getting the most attention right now. Ranked by activity and recency — updated continuously as listings gain traction.
        </p>
      </div>
